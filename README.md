# DexBrain: AI-powered DEX intelligence and routing optimisation platform Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

DexBrain aggregates liquidity depth across major DEXes, solves the optimal split-routing problem with a neural graph network, and executes swaps through a gas-aware transaction bundler.

DexBrain's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/DexBrain.git
cd DexBrain
```
...
- **2024-07-10** — Expand test coverage for edge cases
- **2024-07-30** — Expand test coverage for edge cases
